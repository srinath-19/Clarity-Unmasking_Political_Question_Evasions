...
OUTPUT_DIR = ARTIFACTS_DIR / "clarity_roberta_large_256"
...
def main():
    ...
    print("\nFinal eval results (clarity, RoBERTa-large):", eval_results)

    preds_output = trainer.predict(val_ds)
    preds = preds_output.predictions.argmax(axis=-1)
    y_true = preds_output.label_ids

    print("\nValidation classification report (Clarity, RoBERTa-large):\n")
    print(
    ...
    print(f"\nSaved RoBERTa-large clarity model to: {OUTPUT_DIR}")
