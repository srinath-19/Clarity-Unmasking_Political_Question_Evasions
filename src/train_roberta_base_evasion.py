...
OUTPUT_DIR = ARTIFACTS_DIR / "evasion_roberta_base_256"
...
def main():
    ...
    print("\nFinal eval results (evasion, RoBERTa-base):", eval_results)
    ...
    print("\nValidation classification report (Evasion labels, RoBERTa-base):\n")
    print(
    ...
    print(f"\nSaved RoBERTa-base evasion model to: {OUTPUT_DIR}")
