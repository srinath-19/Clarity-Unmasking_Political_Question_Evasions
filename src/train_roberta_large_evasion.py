...
OUTPUT_DIR = ARTIFACTS_DIR / "evasion_roberta_large_256"
...
def main():
    ...
    print("\nFinal eval results (evasion, RoBERTa-large):", eval_results)
    ...
    print("\nValidation classification report (Evasion labels, RoBERTa-large):\n")
    print(
    ...
    print(f"\nSaved RoBERTa-large evasion model to: {OUTPUT_DIR}")
